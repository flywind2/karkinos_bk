...
public class TumorGenotyperDev extends ReadWriteBase {
	...
	public static void main(String[] arg) {
		...
		TumorGenotyperDev tg = new TumorGenotyperDev();
		try {
			tg.exec(cl);
		} catch (Exception e) {
...
//		//
//		resolvePloidy(dataset,alCNV,pi);
//		//
//		
//				
//		FilterAnnotation fa = new FilterAnnotation(mappability, tgr, tumorbamf,dbAnno,ge);
...
////		/////			
//		CNVUtils.reflectToSNV(dataset,alCNV.getAllelicLOHLow(),alCNV.getAllelicLOHhigh());		
////		
